...
public class EasyMode extends AppCompatActivity {
    ...
    private void setDatabase() {
        Database db=new Database(EasyMode.this);
        Game game=new Game();
        game.gameMode="Kolay";
    ...
    private void buildAlertDialog() {
        AlertDialog.Builder builder=new AlertDialog.Builder(EasyMode.this);
        ...
        builder.setPositiveButton("Yeni Oyun", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                Intent intent=new Intent(EasyMode.this,EasyMode.class);
    ...
    private void getImageViewUI() {
        imageViews.add(findViewById(R.id.easy_img1));
        imageViews.add(findViewById(R.id.easy_img2));
        imageViews.add(findViewById(R.id.easy_img3));
        imageViews.add(findViewById(R.id.easy_img4));
        imageViews.add(findViewById(R.id.easy_img5));
        imageViews.add(findViewById(R.id.easy_img6));
